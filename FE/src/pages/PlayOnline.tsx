...
const PlayOnline = () => {
    ...
    <TextField label="enter room" variant="filled" value={room} type='number' onChange={(e)=>{controlRoom(e)}}/>
    
    <Button color='secondary' variant='contained' onClick={()=>{createGame()}}>Play</Button>
